...
class BatchConcatenationConverter:
    ...
    def tensor_to_fields_batch(
        ...
        for name in self.field_names:
            ...
            field = converter.tensor_to_field(field_tensor, metadata, time_slice=time_slice)
            fields[name] = field
        
        return fields
    
    def _normalize_tensor_shape(self, tensor: torch.Tensor, field_name: str) -> torch.Tensor:
        """
