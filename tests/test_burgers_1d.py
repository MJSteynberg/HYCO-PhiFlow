"""Test script for Burgers 1D - all training modes."""
...
# Setup logging
logger = setup_logger("test_burgers_1d", level="INFO")

def load_config(mode='synthetic'):
    """Load burgers_1d config and modify for quick testing."""
...
def test_data_generation():
    """Test data generation for Burgers 1D."""
    logger.info("="*60)
    logger.info("Testing Burgers 1D Data Generation")
    logger.info("="*60)
...
def test_synthetic_training(config):
    ...
    logger.info("\n" + "="*60)
    logger.info("Testing Burgers 1D Synthetic Training")
    logger.info("="*60)
...
def test_physical_training(config):
    ...
    logger.info("\n" + "="*60)
    logger.info("Testing Burgers 1D Physical Training")
    logger.info("="*60)
...
def test_hybrid_training(config):
    ...
    logger.info("\n" + "="*60)
    logger.info("Testing Burgers 1D Hybrid Training")
    logger.info("="*60)
...
if __name__ == "__main__":
    try:
        ...
        logger.info("\n" + "="*60)
        logger.info("✓ All Burgers 1D tests passed!")
        logger.info("="*60)
