...
class TestFieldValidation:
    ...
    def test_field_validation_matching(self):
        ...
        metadata = {"version": "2.0", "field_metadata": {"velocity": {}, "density": {}}}
    ...
    def test_field_validation_missing_field(self):
        ...
        metadata = {"version": "2.0", "field_metadata": {"velocity": {}}}
...
class TestPDEParamsValidation:
    ...
    def test_pde_params_validation_matching(self):
        ...
        config = {"model": {"physical": {"pde_params": pde_params}}}
        validator = CacheValidator(config)

        metadata = {
            "version": "2.0",
            "generation_params": {},
            "checksums": {"pde_params_hash": compute_hash(pde_params)},
        }
    ...
    def test_pde_params_validation_different(self):
        ...
        config = {"model": {"physical": {"pde_params": {"nu": 0.1}}}}
        validator = CacheValidator(config)
        ...
        metadata = {
            "version": "2.0",
            "generation_params": {},
            "checksums": {"pde_params_hash": compute_hash({"nu": 0.2})},
        }
    ...
    def test_pde_params_validation_missing_hash(self):
        ...
        metadata = {"version": "1.0", "generation_params": {}}
...
class TestResolutionValidation:
    ...
    def test_resolution_validation_matching(self):
        ...
        resolution = {"x": 128, "y": 128}
        config = {"model": {"physical": {"resolution": resolution}}}
        validator = CacheValidator(config)

        metadata = {"version": "2.0", "generation_params": {"resolution": resolution}}
    ...
    def test_resolution_validation_different(self):
        ...
        config = {"model": {"physical": {"resolution": {"x": 128, "y": 128}}}}
        validator = CacheValidator(config)
    ...
    def test_resolution_validation_missing(self):
        ...
        metadata = {"version": "2.0", "generation_params": {}}  # No resolution
...
class TestDomainValidation:
    ...
    def test_domain_validation_matching(self):
        ...
        domain = {"size_x": 100, "size_y": 100}
        config = {"model": {"physical": {"domain": domain}}}
        validator = CacheValidator(config)

        metadata = {"version": "2.0", "generation_params": {"domain": domain}}
    ...
    def test_domain_validation_different(self):
        ...
        config = {"model": {"physical": {"domain": {"size_x": 100, "size_y": 100}}}}
        validator = CacheValidator(config)
...
class TestDtValidation:
    ...
    def test_dt_validation_matching(self):
        ...
        config = {"model": {"physical": {"dt": 0.5}}}
        validator = CacheValidator(config)

        metadata = {"version": "2.0", "generation_params": {"dt": 0.5}}
    ...
    def test_dt_validation_different(self):
        ...
        metadata = {"version": "2.0", "generation_params": {"dt": 1.0}}  # Different dt
    ...
    def test_dt_validation_floating_point_tolerance(self):
        ...
        metadata = {
            "version": "2.0",
            "generation_params": {"dt": 0.5 + 1e-10},  # Very small difference
        }
...
class TestCompleteValidation:
    ...
    def test_validation_all_valid(self):
        ...
        metadata = {
            ...
            "num_frames": 10,
            "generation_params": {"resolution": resolution, "domain": domain, "dt": dt},
            "checksums": {"pde_params_hash": compute_hash(pde_params)},
        }
    ...
    def test_validation_pde_params_mismatch(self):
        ...
        metadata = {
            ...
            "checksums": {"pde_params_hash": compute_hash({"nu": 0.2})},  # Different!
        }
    ...
    def test_validation_multiple_failures(self):
        ...
        metadata = {
            ...
            "checksums": {"pde_params_hash": compute_hash({"nu": 0.2})},  # Wrong params
        }
