...
class TestEvaluatorMultiFieldBehavior:
    ...
    def test_field_specs_construction_in_generate_visualizations(self, smoke_config):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch('src.evaluation.evaluator.create_comparison_gif_from_specs') as mock_anim, \
                 patch('src.evaluation.evaluator.plot_error_vs_time_multi_field') as mock_error, \
                 patch('src.evaluation.evaluator.plot_keyframe_comparison_multi_field') as mock_keyframe, \
                 patch('src.evaluation.evaluator.plot_error_heatmap') as mock_heatmap:
                ...
                if mock_anim.called:
                    ...
                    field_specs = call_args[0][2] if len(call_args[0]) > 2 else call_args[1].get('field_specs')
    ...
    def test_channel_slicing_alignment(self, smoke_config):
        ...
        assert channels_used == total_channels, \
